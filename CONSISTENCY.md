...
> 网页版：`docs/`（本目录，GitHub Pages，**冻结于 v1.3.8**）　小程序版：`WeChatProjects/miniprogram-1`（**v1.4.6**）
...
**v1.4.3–v1.4.6 状态**：四轮均为**小程序端独有**的收尾修复 ——
...
| 版本号展示 | 页面右下角灰色小字 `v1.3.8`（`APP_VERSION`，**已冻结**） | 同左（`version` 字段绑定），小程序端当前 **v1.4.6** |
